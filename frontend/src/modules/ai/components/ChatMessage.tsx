        ...
        {message.isStreaming ? (
          ...
          <div className="rounded-xl bg-white/5 px-3 py-2.5 border border-white/5">
            <div className="text-sm leading-relaxed text-slate-200 space-y-1.5">
              <ReactMarkdown
                components={{
                  h1: ({node: _node, ...props}) => <h1 className="text-lg font-bold text-white mt-3 mb-1.5" {...props} />,
                  h2: ({node: _node, ...props}) => <h2 className="text-base font-bold text-white mt-2.5 mb-1.5" {...props} />,
                  h3: ({node: _node, ...props}) => <h3 className="text-sm font-bold text-white mt-2 mb-1" {...props} />,
                  ul: ({node: _node, ...props}) => <ul className="list-disc pl-5 my-0.5 space-y-0.5" {...props} />,
                  ol: ({node: _node, ...props}) => <ol className="list-decimal pl-5 my-0.5 space-y-0.5" {...props} />,
                  li: ({node: _node, ...props}) => <li className="text-slate-200 text-sm leading-relaxed" {...props} />,
                  p: ({node: _node, ...props}) => <p className="text-sm leading-relaxed text-slate-200 min-h-[1em]" {...props} />,
                  strong: ({node: _node, ...props}) => <strong className="font-bold text-white" {...props} />,
                  em: ({node: _node, ...props}) => <em className="italic text-slate-300" {...props} />
                }}
              >
